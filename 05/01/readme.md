...
Вам нужно будет создать три класса: для фигуры, треугольника и четырёхугольника. Назовём их `Figure`, `Triangle` и `Quadrangle`.
...
Для правильной инициализации информации о количестве сторон создадайте конструкторы в классах, где присвойте нужное значение полю `sides_count`. Если вы сделали `sides_count` защищённым, вы можете присвоить значени прямо в конструкторе. Если приватным, то вам нужно создать в классе `Figure` защищённый конструктор с параметром (количество сторон) и публичный конструктор без параметров, который будет вызывать свой защищённый конструктор с параметром. Защищённый конструктор должны будут вызывать дочерние классы в своих публичных конструкторах без параметров.
