...
План:
1. [IDE (от англ. Integrated development environment — Интегрированная среда разработки)](https://github.com/netology-code/cppm-homeworks/blob/main/common/instr/readme.md#ide)
