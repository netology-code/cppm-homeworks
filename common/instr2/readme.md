...
1. Можем попробовать сделать проверку в начале вызова:
...
Так будет работать, но это плохое решение. Внутри main, внешнего кода, мы думаем за функцию: какие параметры можно передавать, а какие нельзя. Логика получается размазанной, часть логики во внешнем коде, часть внутри функции. Особенно это не удобно это, если много функций, в которых разные условия работы.
