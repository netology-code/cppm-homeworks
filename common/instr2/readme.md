...
Теперь представим, что вы вызвали функцию чтения из файла, а она вам вернула код возврата в виде какое-то числа.
...
Очевидно, что просто число без документации — это совершенно не информативно. Хорошо, если документация есть и её можно прочитать, но ещё лучше — если код документирует сам себя. Это, конечно, идеальная ситуация. Такого не бывает, но стремиться к этому нужно. Чем более понятна ваша функция, тем лучше.
