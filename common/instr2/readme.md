...
Перечисление — это тип данных, который позволяет создавать набор логически связанных констант. 
...
Каждое перечисление фактически определяет новый тип данных, с помощью которых мы также, как и с помощью любого другого типа, можем определять переменные, параметры методов и т.д.
