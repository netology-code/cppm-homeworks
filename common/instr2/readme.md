...
Чтобы в программе были логи, их нужно написать. Вы не сможете это сделать на любую возможную проблему. Если будет слишком много логов, программа начнёт тормозить, или у пользователя внезапно закончится свободное место на диске.
