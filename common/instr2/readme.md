...
Тем не менее, использование кода возврата является наилучшим решением с точки зрения производительности. Однако имеет недостатки с точки зрения безопасности и удобства.
