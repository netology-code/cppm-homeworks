...
Если мы поменяем знаменатель на int b = 5:
...
![image](https://github.com/netology-code/cppm-homeworks/assets/147130852/bed30e9b-5843-496e-a78c-da156809611f)
...
Указатель также нужно проверить внутри функции, так как есть вероятность передать его с ошибкой.

В C++ не все типы можно сконструировать. Например, если у класса нет конструктора по умолчанию, то мы его сконструировать не сможем.
