...
### Зачем вообще использовать все рассмотренные способы?
...
- Остаётся проблема возврата какого-то значения из функции — исключения решают эту проблему, прерывая выполнение. Печатание на экран не решает проблему выполнения каких-то особенных действий в случае ошибки.
