...
Символы, обозначающие окончание строки, различаются в Windows и Unix-подобных операционных систем (Mac OS, Linux, FreeBSD), поэтому выберите опцию `Checkout Windows-style, commit Unix-style line-endings` и нажмите кнопку `Next`:
